...
Issues and PRDs for this repository live in GitHub Issues at `nisavid/cqmgr`.
Use the `gh` CLI for tracker operations.

## Conventions

- Create: `gh issue create --repo nisavid/cqmgr --title "..." --body-file <path>`
- Read: `gh issue view <number> --repo nisavid/cqmgr --comments`
- List: `gh issue list --repo nisavid/cqmgr --state open`
- Comment: `gh issue comment <number> --repo nisavid/cqmgr --body-file <path>`
- Label: `gh issue edit <number> --repo nisavid/cqmgr --add-label "..."`
- Close: `gh issue close <number> --repo nisavid/cqmgr`
...
- Claim with
  `gh issue edit <number> --repo nisavid/cqmgr --add-assignee @me`.
