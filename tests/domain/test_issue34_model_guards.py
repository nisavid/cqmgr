...
def test_canonical_zone_predicate_accepts_exact_zone_ids(value: object) -> None:
    """Canonical Compute and TPU zones share one accepting predicate."""
    assert is_canonical_zone(value)
